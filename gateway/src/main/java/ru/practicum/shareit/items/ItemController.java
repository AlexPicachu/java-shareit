...
public class ItemController {
    ...
    /**
     * Метод валидации входящих параметров, перед добавлением новой вещи
     */
    @PostMapping
    ...
    /**
     * Метод валидации входящих параметров, перед обновлением существующей вещи
     */
    @PatchMapping("/{id}")
    ...
    /**
     * Метод валидации входящих параметров, перед запросом вещи по id
     */
    @GetMapping("/{id}")
    ...
    /**
     * Метод валидации входящих параметров, перед запросом всех вещей конкретного пользователя
     */
    @GetMapping
    ...
    /**
     * Метод валидации входящих параметров, перед поиском вещи по ее названию или описанию
     */
    @GetMapping("/search")
    ...
    /**
     * Метод валидации входящих параметров, перед добавлениев нового комментария
     */
