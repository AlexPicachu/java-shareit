...
public class BookingClient extends BaseClient {
    ...
    /**
     * метод, в случае удачной валидации, отправляет запрос на изменение статуса
     */
    ...
    /**
     * метод, в случае удачной валидации, отправляет запрос для просмотра бронирования
     */
    ...
    /**
     * метод, в случае удачной валидации, отправляет запрос для просмотра всех бронирований пользователя
     */
